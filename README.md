...
consumer of the module could care about, not a list of git commits, so please
check it out!
...
As this table is getting a little wide, with how npm and github display it, you
